...
app.controller("OfflineBusiness", function ($scope, $http) {
    ...
    $scope.RemoveSpecialChar = function (scopeModel) {
        $scope.PolicyNo = scopeModel.replace(/[^a-zA-Z0-9]/g, '');//replace(/[^a-zA-Z ]/g, "");
    }
    ...
    function NetPremiumCalculation() {
        ...
        $scope.BasicOD = Od + addon;
        $scope.NetPremium = Od + addon + tp + cp;
    }
