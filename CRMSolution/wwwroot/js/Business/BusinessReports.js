...
app.controller("BusinessMaster", function ($scope, $http) {
    ...
    $scope.EditDelete = function (policyno, option, product) {//--Sunil--
        let Url = "";
        if (product.toLowerCase() == "privatecar" || product.toLowerCase() == "mot") {
            product = "MOT";
            if (option == "Del")
        ...
        if (product.toLowerCase() == "twowheeler") {
            product = "MOT";
            if (option == "Del")
                Url = "/api/BusinessReport/DeleteOfflinePolicy";
            else
        ...
        } else if (product.toLowerCase() == "life") {
            if (option == "Del")
                Url =  "/api/BusinessReport/DeleteOfflinePolicy";
            else
                Url = "/myaccount/business/OfflineUpdatelifepolicy?policyno=" + policyno;
        } else if (product.toLowerCase() == "pcv") {
            product = "MOT";
            if (option == "Del")
                Url = "/api/BusinessReport/DeleteOfflinePolicy";
            else
                Url = "/myaccount/business/OfflineUpdateCommercialPolicy?policyno=" + policyno;
        } else if (product.toLowerCase() == "gcv") {
            product = "MOT";
            if (option == "Del")
                Url = "/api/BusinessReport/DeleteOfflinePolicy";
            else
