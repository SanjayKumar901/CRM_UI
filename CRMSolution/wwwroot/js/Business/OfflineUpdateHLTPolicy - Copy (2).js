        ...
        if (tab == 'ManualOffline') {
            ...
            $http.post(CallApiPostMethod, model).then(function (Response) {
                ...
                if (PolicyDetails != null) {
                    ...
                    if (PolicyDetails.customerDOB != null)
                        $("input[ng-model='ManualCustomerDOB']").val(PolicyDetails.customerDOB.substring(0, 10));
                    ...
                    $scope.ManualTotalPremium = PolicyDetails.totalPremium;
                    //$scope.ManualNetPremium = PolicyDetails.totalPremium;
                    ...
                    $("input[ng-model='ManualStartDate']").val(PolicyDetails.startDate.substring(0, 10))
                    $("input[ng-model='ManualEndDate']").val(PolicyDetails.endDate.substring(0, 10))
                    $("input[ng-model='ManualPolicyIssueDate']").val(PolicyDetails.policyIssueDate.substring(0, 10))
                    $("input[ng-model='ManualChecqueDate']").val(PolicyDetails.checqueDate.substring(0, 10))
                }
                GetInsurerList();
                GetStates();
            }, function (Response) {
